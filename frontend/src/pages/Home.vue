  ...
  <div class="mx-20">
    ...
    <Dialog :options="{
      ...
      <template #body-content>
        <div class="space-y-2">
          <Input v-model="action.title" type="text" required placeholder="Give your action a title..." label="Title" />
          <Input v-model="action.description" label="Description" type="textarea" required placeholder="Give your action a Description..."/>
          <Input v-model="action.date" type="date" label="Date" required placeholder="Give your action a Date..."/>
